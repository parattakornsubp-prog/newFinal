# ImageNet 1000 class labels (standard synset order)
IMAGENET_LABELS = [
    ...
    "Carolina anole", "desert grassland whiptail lizard", "agama", "frilled-neck lizard", "alligator lizard",
    ...
    "sea snake", "Saharan horned viper", "eastern diamondback rattlesnake", "sidewinder rattlesnake", "trilobite",
    ...
    "cardigan", "car mirror", "carousel", "tool kit", "cardboard box",
    ...
    "bell", "china cabinet", "Christmas stocking", "church", "movie theater",
    "cleaver", "cliff dwelling", "cloak", "clogs", "cocktail shaker",
    "coffee mug", "coffeemaker", "spiral", "combination lock", "computer keyboard",
    ...
    "tank", "miniskirt", "minivan", "missile", "mitten",
    ...
    "pan flute", "paper towel", "parachute", "parking meter", "party popper",
    ...
    "pillow", "ping-pong ball", "pinwheel", "pirate ship", "pitcher",
    "hand plane", "planetarium", "plastic bag", "plate rack", "farm plow",
    ...
    "through arch bridge", "steel drum", "stethoscope", "scarf", "stretcher",
    "couch", "stupa", "submarine", "suit", "sundial",
    "sunglass", "sunglasses", "sunscreen", "suspension bridge", "mop",
    "sweatshirt", "swim trunks", "swing", "switch", "syringe",
    ...
    "toilet seat", "torch", "totem pole", "tow truck", "toy store",
    ...
    "upright piano", "vacuum cleaner", "vase", "viaduct", "violin",
    ...
    "wooden spoon", "wool", "split-rail fence", "shipwreck", "sailboat",
    "yurt", "website", "comic book", "crossword", "traffic or street sign",
    "traffic light", "dust jacket", "menu", "plate", "guacamole",
    "consomme", "hot pot", "trifle", "ice cream", "popsicle",
    ...
    "jackfruit", "cherimoya", "pomegranate", "hay", "carbonara",
    "chocolate syrup", "dough", "meatloaf", "pizza", "pot pie",
    "burrito", "red wine", "espresso", "tea cup", "eggnog",
    "mountain", "bubble", "cliff", "coral reef", "geyser",
    "lakeshore", "promontory", "sandbar", "beach", "valley",
    ...
    "earth star fungus", "hen of the woods mushroom", "bolete", "ear of corn", "toilet paper",
]
